...
const Player = ({user, isCurrentUser, isPlayer}:IPlayerProps):JSX.Element => {
  ...
  return(
    <div className={styles.card}>
      {user?.image?  <img className={styles.img} src={user?.image}></img> : <div className={styles.avatar}>{name(user.firstName, user?.lastName)}</div>}
    <div className={styles.name}>
     ...
     {isPlayer&& <div className={styles.remove}>
